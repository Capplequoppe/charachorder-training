...
export const FINGER_NOTES: Record<FingerId, FingerAudioConfig | null> = {
  ...
  l_pinky: null, // No sound by default - pinky has modifier assignments
  ...
  l_thumb_third: null, // No sound by default - third thumb has modifier assignments

  l_arrow: null, // No sound by default - arrow keys

  l_trackball: null, // No sound by default - trackball controls
  ...
  r_pinky: null, // No sound by default - pinky has modifier assignments
  ...
  r_thumb_third: null, // No sound by default - third thumb has modifier assignments

  r_arrow: null, // No sound by default - arrow keys

  r_trackball: null, // No sound by default - trackball controls
...
export const OPTIMIZED_INTERVALS: Record<string, IntervalType> = {
  ...
  'l_thumb_second|r_thumb_second': 'octave', // E3 + E4 = octave
  'l_ring|r_thumb_first': 'octave', // A4 + A3? No, but A4 + G3 = major 2nd

  // Perfect 5ths (very consonant)
  'l_thumb_second|r_index': 'perfect_5th', // E3 + B3 = perfect 5th
  ...
  'l_thumb_first|r_thumb_first': 'major_2nd', // A3 + G3 = major 2nd
  'r_index|r_thumb_first': 'major_3rd', // B3 + G3 = major 3rd
